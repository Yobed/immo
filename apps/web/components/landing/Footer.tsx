...
const columns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'WhatsApp principal', href: 'https://wa.me/2250574243752' },
      { label: 'WhatsApp support', href: 'https://wa.me/225078311541' },
