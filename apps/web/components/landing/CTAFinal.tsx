    ...
    <section className="py-24 relative overflow-hidden bg-[var(--primary)]">
      ...
      <div className="relative container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/biens"
            className="btn-secondary-glow inline-flex items-center justify-center gap-2.5 font-sans font-semibold rounded-btn bg-[var(--secondary)] text-white px-8 py-4 text-base"
          >
          ...
          <Link
            href="/register"
            className="inline-flex items-center justify-center gap-2.5 font-sans font-semibold rounded-btn border-2 border-white/30 text-white hover:bg-white/10 transition-colors duration-200 px-8 py-4 text-base"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none">
