      ...
      <div className="relative z-10 mx-auto px-4 md:px-6 max-w-7xl">
        ...
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight">
            ...
            <span className="italic font-light text-[#D97706]">en lumière</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-5xl mx-auto">
          ...
          <Link
            ...
            className="group relative bg-gradient-to-br from-[#1a1f2e] via-[#0f172a] to-[#020617] rounded-3xl p-7 md:p-9 border border-white/10 hover:border-[#D97706]/50 transition-all duration-500 overflow-hidden"
          >
            {/* Glow */}
            <div className="absolute -top-20 -right-20 w-60 h-60 bg-[#D97706]/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />

            <div className="relative z-10">
              {/* Crown badge */}
              <div className="absolute top-0 right-0 flex items-center gap-1 px-2.5 py-1 bg-[#D97706]/20 border border-[#D97706]/40 rounded-full">
                <Crown className="w-3 h-3 text-[#D97706]" />
                <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#D97706]">Premium</span>
              </div>

              {/* Icon */}
              <div className="w-14 h-14 rounded-2xl bg-[#D97706]/10 border border-[#D97706]/30 flex items-center justify-center mb-6">
                <Building2 className="w-6 h-6 text-[#D97706]" strokeWidth={1.5} />
              </div>
              ...
              <p className="text-slate-400 text-sm md:text-base leading-relaxed mb-6">
                Inscrivez-vous, gérez vos annonces, suivez les visites, signez les baux en ligne. Affichez le badge <span className="text-[#D97706] font-semibold">Vérifié</span>.
              </p>
