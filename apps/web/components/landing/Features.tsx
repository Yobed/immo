...
const features = [
  ...
  {
    id: 'paiement',
    title: 'Transactions Mobiles',
    description: 'Règlements sécurisés via Wave & Orange Money pour une fluidité absolue.',
    icon: (
  ...
  {
    id: 'contrat',
    title: 'Cadre Légal OHADA',
    description: 'Baux conformes générés avec une rigueur juridique, signés en un clic.',
    icon: (
              ...
              <div className="h-full bg-[var(--surface-card)] border border-[var(--border)] p-8 backdrop-blur-3xl transition-all duration-700 ease-expo group-hover:bg-[var(--primary-light)] group-hover:border-[var(--border-hover)]">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-10 flex items-center gap-4">
                    ...
                    {f.featured && (
                      <span className="text-[11px] font-sans tracking-[0.2em] uppercase text-[var(--text)] opacity-50">
                        Signature Item
                      </span>
                    )}
                  </div>
