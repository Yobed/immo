  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden flex items-center gap-2 px-4 py-2 rounded-btn border border-[var(--border)] bg-white font-sans text-sm text-[var(--text)] hover:border-primary/40 transition-colors"
      >
      ...
      {/* Drawer */}
      <div className={`fixed inset-y-0 left-0 w-80 max-w-[90vw] bg-white z-50 shadow-xl transform transition-transform duration-300 lg:hidden overflow-y-auto ${open ? 'translate-x-0' : '-translate-x-full'}`}>
