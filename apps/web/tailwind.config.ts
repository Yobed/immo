  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'secondary-glow': '0 4px 20px rgba(191,140,44,0.25), 0 2px 8px rgba(191,140,44,0.15)',
      ...
      backgroundImage: {
        ...
        'gradient-gold':    'linear-gradient(135deg, #BF8C2C 0%, #E8B84B 50%, #BF8C2C 100%)',
