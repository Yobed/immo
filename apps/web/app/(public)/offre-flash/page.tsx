...
export const metadata = {
  ...
  openGraph: {
    title: "9 000+ offres flash immobilières en Côte d'Ivoire — BOGBE'S GROUPE",
    description: "Annonces WhatsApp captées en temps réel. Vérification conseiller avant chaque visite. Zéro arnaque.",
    type: 'website',
  },
}
