  ...
  return (
    <div className="min-h-screen bg-[var(--surface)] animate-pulse">
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-4">
        <div className="h-8 bg-[var(--surface-card)] rounded-card border border-[var(--border)] w-56" />
        <div className="space-y-3">
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="bg-[var(--surface-card)] rounded-card border border-[var(--border)] p-4 flex gap-4">
